...
- Recurrent Selective Scan Max Absolute Error: `0.000e+00` (Threshold: $< 10^{-5}$)
- Fused Residual Gate Max Absolute Error: `0.000e+00` (Threshold: $< 10^{-5}$)
- **Status**: **PASS**
...
- **Episodic Exception Recall**: AURELIS-E achieves a **4.09x** lower error on memorized exceptions over AURELIS-B (MSE 0.0241 vs 0.0985) while maintaining equal latent denoising MSE (0.0152 vs 0.015).
