# Phase 9 — Independent reproduction, paper finalization, and release audit

Start only after Phase 8 PASS. Read the entire repository and
...
- independently regenerate the central numerical, learned, systems, tiny-LM,
  125M parameter / 1B token scale study, and 350M parameter / 3B token scale study
  from pinned configs/checkpoints;
...
- There are exactly ten numbered phases, `phase0.md` through `phase9.md`.
...
- `results/phase9/PASS.md` contains the full completion matrix and shared PASS
